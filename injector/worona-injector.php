...
(function(document, window){
  /** UAParser.js v0.7.13 Lightweight JavaScript-based User-Agent string parser https://github.com/faisalman/ua-parser-js Copyright © 2012-2016 Faisal Salman <fyzlman@gmail.com> Dual licensed under GPLv2 & MIT */
  ...
  var wpType = '<?php echo $wpType ?>';
  var wpId = '<?php echo $wpId ?>';
